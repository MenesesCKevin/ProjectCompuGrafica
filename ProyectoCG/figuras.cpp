...
void CFiguras::plano(float altura, float largo, float profundidad, GLuint text, GLfloat n)  //Funcion creacion de plano
{
...
void CFiguras::hoja(float altura, float largo, float profundidad, GLuint text, GLfloat n)  //Funcion creacion de la hoja
{

	GLfloat vertice[8][3] = {
		{ 0.5*largo ,-0.5*altura, 0.5*profundidad },    //Coordenadas Vértice 1 V1
		{ -0.5*largo ,-0.5*altura , 0.5*profundidad },    //Coordenadas Vértice 2 V2
		{ -0.5*largo ,-0.9*altura , -0.5*profundidad },    //Coordenadas Vértice 3 V3
		{ 0.5*largo ,-0.5*altura , -0.5*profundidad },    //Coordenadas Vértice 4 V4
		{ 0.5*largo ,0.5*altura , 0.5*profundidad },    //Coordenadas Vértice 5 V5
		{ 0.5*largo ,0.5*altura , -0.5*profundidad },    //Coordenadas Vértice 6 V6
		{ -0.5*largo ,0.5*altura , -0.5*profundidad },    //Coordenadas Vértice 7 V7
...
void CFiguras::prisma2 (GLuint text, GLuint text2, GLfloat n)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);	//Front
			...
			glTexCoord2f(n, n); glVertex3fv(vertice[7]);
			glTexCoord2f(0.0f, n); glVertex3fv(vertice[1]);
		glEnd();
		...
		glBegin(GL_POLYGON);	//Right
			...
			glTexCoord2f(n, 0.0f); glVertex3fv(vertice[3]);
			glTexCoord2f(n, n); glVertex3fv(vertice[5]);
			glTexCoord2f(0.0f, n); glVertex3fv(vertice[4]);
		glEnd();

		glBegin(GL_POLYGON);	//Back
			glNormal3f( 0.0f, 0.0f,-1.0f);
			glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[6]);
			glTexCoord2f(n, 0.0f); glVertex3fv(vertice[5]);
			glTexCoord2f(n, n); glVertex3fv(vertice[3]);
			glTexCoord2f(0.0f, n); glVertex3fv(vertice[2]);
		glEnd();

		glBegin(GL_POLYGON);  //Left
			glNormal3f(-1.0f, 0.0f, 0.0f);
			glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
			glTexCoord2f(n, 0.0f); glVertex3fv(vertice[7]);
			glTexCoord2f(n, n); glVertex3fv(vertice[6]);
			glTexCoord2f(0.0f, n); glVertex3fv(vertice[2]);
		glEnd();
		...
		glBegin(GL_POLYGON);  //Bottom
			glNormal3f( 0.0f,-1.0f, 0.0f);
			glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
			glTexCoord2f(n, 0.0f); glVertex3fv(vertice[1]);
			glTexCoord2f(n, n); glVertex3fv(vertice[2]);
...
void CFiguras::prisma3 (GLuint text, GLuint text2, GLfloat n_x, GLfloat n_y)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(n_y, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(n_y, n_x); glVertex3fv(vertice[7]);
	glTexCoord2f(0.0f, n_x); glVertex3fv(vertice[1]);
	glEnd();

	glBegin(GL_POLYGON);	//Right
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(n_y, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(n_y, n_x); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, n_x); glVertex3fv(vertice[4]);
	glEnd();

	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(n_x, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(n_x, n_y); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, n_y); glVertex3fv(vertice[2]);
	glEnd();

	glBegin(GL_POLYGON);  //Left
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(n_x, 0.0f); glVertex3fv(vertice[7]);
	glTexCoord2f(n_x, n_y); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, n_y); glVertex3fv(vertice[2]);
	glEnd();
	...
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(n_x, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(n_x, n_y); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, n_y); glVertex3fv(vertice[3]);
	glEnd();

	glBindTexture(GL_TEXTURE_2D, text);   // choose the texture to use.
	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(n_x, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(n_x, n_y); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, n_y); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[7]);
	glEnd();
}
...
void CFiguras::prisma4(GLuint front, GLuint right, GLfloat back, GLfloat left, GLfloat bottom, GLfloat top)  //Funcion creacion prisma
{
	...
	glBindTexture(GL_TEXTURE_2D, front);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Front
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(1, 1); glVertex3fv(vertice[7]);
	glTexCoord2f(0.0f, 1); glVertex3fv(vertice[1]);
	glEnd();
	...
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1, 0.0f); glVertex3fv(vertice[3]);
	...
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(1, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(1, 1); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, 1); glVertex3fv(vertice[2]);
	glEnd();
	...
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(1, 0.0f); glVertex3fv(vertice[7]);
	...
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(1, 1); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, 1); glVertex3fv(vertice[3]);
	glEnd();
